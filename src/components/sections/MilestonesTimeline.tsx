const MILESTONES = [
  {
    ...
    description: 'Legitimate Properties launched with a focus on trusted advisory and carefully selected residential listings.',
  },
  {
    year: '2015',
    title: 'First Development Completed',
    description: 'We delivered our first signature project and established the quality benchmark that still guides our work.',
  },
  {
    year: '2019',
    title: 'Expanded to a Second City',
    description: 'Our portfolio grew beyond Abuja, opening access to clients seeking opportunities in another key market.',
  },
  {
    year: '2024',
    title: 'Operating at Scale',
    description: 'Today we support buyers, investors, and partners with a broader portfolio and a stronger advisory team.',
  },
]
